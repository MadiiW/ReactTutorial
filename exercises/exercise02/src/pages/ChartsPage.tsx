...
export default function ChartsPage() {
  ...
  useEffect(() => {
    // TODO 3: Schreibe hier einen API Call der die aktuellen Top 10 Tracks von Deezer abruft
  ...
  return (
    <div className="mb-10">
      {
        // TODO 2: Hier soll der Song des Tages angezeigt werden
      ...
      <ul className="grid sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
        {topTracks.map((track, index) => (
          // TODO 4: Implementiere eine SongCard Component und zeige sie hier für jeden Song an
